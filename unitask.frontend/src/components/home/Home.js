...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-purple-900 to-violet-600 text-white">
      <div className="relative z-10 flex-grow">
        ...
        <motion.div 
          className="w-full h-full px-4 py-12 relative"
          initial="hidden"
          animate="visible"
